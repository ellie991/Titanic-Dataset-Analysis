library(rpart)
library(rpart.plot)
train_data <- read.csv("/Users/elenavaldes/Desktop/Titanic/train.csv", fileEncoding = "UTF-8")
test_data <- read.csv("/Users/elenavaldes/Desktop/Titanic/test.csv")
...
#IPOTESI 2: PREDIZIONI SOPRAVVIVENZA IN BASE ALL'ETÀ
#CLUSTERING ETA'
